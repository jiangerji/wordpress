<div id="share_toolbar_wrapper" style="position: static; top: auto; z-index: 9999;">
	<div id="share_toolbar">
		<div class="stb_group" id="stb_article_view" title="本文围观次数">
			...
			<span id="stb_view_count"><?php if ( function_exists('custom_the_views') ) custom_the_views($post->ID); ?></span>
		</div>
		...
		<!--修改下一行的百度分享ID-->
		<script type="text/javascript" id="bdshare_js" data="type=button&amp;uid=89860593" ></script>
